...
func (r *mutationResolver) AddPokemon(ctx context.Context, input model.NewPokemon) (*model.Pokemon, error) {
	...
	var id int64
	id = AddPokemon(r.DB.DBPointer, input.Name, input.Description, input.Category, typeString, abilitiesString)
...
func (r *mutationResolver) UpdatePokemon(ctx context.Context, input model.NewPokemon) (*model.Pokemon, error) {
	...
	UpdatePokemon(r.DB.DBPointer, int(id_int64), input.Name, input.Description, input.Category, typeString, abilitiesString)
